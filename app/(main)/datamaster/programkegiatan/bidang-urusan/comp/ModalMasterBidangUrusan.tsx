...
interface modal {
    ...
    onClose: () => void;
    onSuccess: () => void;
    Data: GetResponseFindallBidangUrusan | null
}
interface FormValue {
    id: string;
...
export const ModalMasterBidangUrusan: React.FC<modal> = ({ isOpen, onClose, onSuccess, jenis, Data }) => {
    ...
    const onSubmit: SubmitHandler<FormValue> = async (data) => {
        ...
        try {
            setProses(true);
            await apiFetch(jenis === "tambah" ? `${branding?.api_perencanaan}/bidang_urusan/create` : `${branding?.api_perencanaan}/bidang_urusan/update/${Data?.id}`, {
                    ...
                    >
                        ...
                        <div className="flex flex-col py-3">
                            <label className="uppercase text-xs font-bold text-gray-700 my-2">
                                Nama Bidang Urusan : {errors.nama_bidang_urusan && "wajib diisi"}
                            </label>
                            <Controller
                        ...
                        <div className="flex flex-col py-3">
                            <label className="uppercase text-xs font-bold text-gray-700 my-2">
                                Kode Bidang Urusan : {errors.kode_bidang_urusan && "wajib diisi"}
                            </label>
                            <Controller
