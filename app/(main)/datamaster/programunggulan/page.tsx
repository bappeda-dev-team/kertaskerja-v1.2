...
const MasterProgramUnggulanPage = () => {

    const menu = [
        { label: "Data Master", href: "/" },
        { label: "Program Unggulan", href: "/datamaster/programunggulan", active: true }
    ]
            ...
            <Card>
                <HeaderCard>
                    <div className="flex flex-wrap items-end">
                        <h1 className="uppercase font-bold">Program</h1>
...
export default MasterProgramUnggulanPage;