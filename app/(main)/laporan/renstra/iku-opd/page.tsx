...
import TablePemda from "@/app/(main)/perencanaan-opd/renstra/iku-opd/comp/Table";
...
const IkuOpdPage = () => {
    ...
    const menu = [
        ...
        { label: "Renstra", href: "/" },
        { label: "IKU OPD", href: "/perencanaan-opd/renstra/iku-opd", active: true }
    ]
                ...
                <div className="mt-3 rounded-xl shadow-lg border border-gray-200">
                    <div className="flex flex-wrap items-center justify-between border-b border-gray-200 px-5 py-5">
                        <div className="flex flex-col gap-1">
                            <h1 className="font-bold text-lg uppercase">IKU OPD {`(${Periode?.tahun_awal || ""} - ${Periode?.tahun_akhir || ""})`}</h1>
