...
import { TableMatrixRenstra } from "@/app/(main)/perencanaan-opd/renstra/matrix-renstra/comp/TableMatrixRenstra";
...
const MatrixRenstraPage = () => {

    const menu = [
        { label: "Laporan", href: "/" },
        { label: "Renstra", href: "/" },
        { label: "Matrix Renstra", href: "/laporan/renstra/matrix-renstra", active: true }
    ]
                ...
                <div className="mt-3 rounded-xl shadow-lg border border-gray-200">
                    <div className="flex flex-wrap items-center justify-between border-b border-gray-200 px-5 py-5">
                        <div className="flex flex-col gap-1">
                            <h1 className="font-bold text-lg uppercase">Matrix Renstra {`(${Periode?.tahun_awal || ""} - ${Periode?.tahun_akhir || ""})`}</h1>
...
export default MatrixRenstraPage;