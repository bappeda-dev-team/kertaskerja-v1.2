...
import Table from "@/app/(main)/perencanaan-opd/renstra/sasaran-opd/comp/Table";
...
const SasaranOpdPage = () => {
    ...
    const menu = [
        { label: "Laporan", href: "/" },
        { label: "Renstra", href: "/" },
        { label: "Sasaran OPD", href: "/laporan/renstra/sasaran-opd", active: true }
    ]
                ...
                <div className="mt-3 rounded-xl shadow-lg border border-gray-200">
                    <div className="flex flex-wrap items-center justify-between border-b border-gray-200 px-5 py-5">
                        <div className="flex flex-col gap-1">
                            <h1 className="font-bold text-lg uppercase">Sasaran OPD {`(${Periode?.tahun_awal || ""} - ${Periode?.tahun_akhir || ""})`}</h1>
