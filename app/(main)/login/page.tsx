...
const LoginPage = () => {
    ...
    const client = process.env.NEXT_PUBLIC_CLIENT_NAME;
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-8 rounded-lg shadow-md w-96">
                <div className="flex flex-col items-center">
                    <Image
                        ...
                        height={90} 
                    />
                    <h1 className="text-2xl font-bold mt-3 text-center uppercase">{app}</h1>
                    <h1 className="text-lg font-thin mb-6 text-center">{client}</h1>
                </div>
                {/* NIP */}
                <div className="mb-4">
