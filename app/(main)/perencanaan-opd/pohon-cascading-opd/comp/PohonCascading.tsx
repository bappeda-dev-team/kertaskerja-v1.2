...
import { TbUsersPlus, TbEye, TbPrinter, TbCircleCheckFilled } from 'react-icons/tb';
...
export const PohonCascading: React.FC<pohon> = ({ tema, deleteTrigger, show_all, set_show_all }) => {
    ...
    const hapusPelaksana = async (id: any) => {
        await apiFetch(`${branding?.api_perencanaan}/pohon_kinerja_opd/delete_pelaksana/${id}`, {
            method: "DELETE"
        }).then((_) => {
                ...
                <>
                    ...
                    >
                        ...
                        <div className="flex justify-center my-3">
                            {Edited ?
                                <TablePohonEdited item={Edited} hapusPelaksana={hapusPelaksana} user={branding?.user?.roles} />
                                :
                                <TablePohon item={tema} hapusPelaksana={hapusPelaksana} user={branding?.user?.roles} />
                            }
                        </div>
                        ...
                        >
                            ...
                            <ButtonBlackBorder className={`px-3 bg-white flex justify-center items-center py-1 bg-linear-to-r rounded-lg hide-on-capture`}
                                onClick={handleShow}
                            >
