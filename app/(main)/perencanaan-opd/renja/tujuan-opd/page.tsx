...
const RenjaTujuanOpdPage = () => {

    const menu = [
        { label: "Perencanaan OPD", href: "/" },
        { label: "Renja", href: "/" },
        { label: "Tujuan OPD", href: "/perencanaan-opd/renja/tujuan-opd", active: true }
    ]
                ...
                <div className="mt-3 rounded-xl shadow-lg border border-gray-200">
                    <div className="flex flex-wrap items-center justify-between border-b border-gray-200 px-5 py-5">
                        <div className="flex flex-col gap-1">
                            <h1 className="font-bold text-lg uppercase">Tujuan OPD {branding?.tahun?.label}</h1>
...
export default RenjaTujuanOpdPage;