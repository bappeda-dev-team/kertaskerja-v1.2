...
import { FormValue, Tagging, indikator, target } from '../type';
...
export const FormPohonPemda: React.FC<{
...
}> = ({ id, level, formId, onCancel, EditBerhasil }) => {
    ...
    const onSubmit: SubmitHandler<FormValue> = async (data) => {
        ...
        try {
            setProses(true);
            let url = `${branding?.api_perencanaan}/pohon_kinerja_admin/create`;
            setProses(true);
            await apiFetch(url, {
                method: "POST",
...
export const FormEditPohon: React.FC<{
    ...
    const onSubmit: SubmitHandler<FormValue> = async (data) => {
        ...
        try {
            setProses(true);
            let url = `${branding?.api_perencanaan}/pohon_kinerja_admin/update/${id}`;
            setProses(true);
            await apiFetch(url, {
                method: "PUT",
                body: JSON.stringify(formData)
